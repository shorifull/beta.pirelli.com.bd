...
class HomeController
{
    public function index()
    {
        ...
        $settings6 = [
            'chart_title'           => 'Total Warranty Claim',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings7 = [
            'chart_title'           => 'Moto Warranty Registration',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\MotoRegistration',
            'group_by_field'        => 'date_purchased',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'motoRegistration',
        ];
        ...
        $settings8 = [
            'chart_title'           => 'Car Warranty Registration',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\CarRegistration',
            'group_by_field'        => 'date_purchased',
            'group_by_period'       => 'day',
            'aggregate_function'    => 'count',
            'filter_field'          => 'created_at',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'carRegistration',
        ];
        ...
        $settings9 = [
            'chart_title'           => 'Warranty Claim by Day',
            'chart_type'            => 'bar',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\WarrantyClaim',
            'group_by_field'        => 'created_at',
        ...
        $settings10 = [
            'chart_title'        => 'Warranty Claim to Retailer',
            'chart_type'         => 'pie',
        ...
        $settings12 = [
            'chart_title'           => 'Latest Warranty Claims',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\WarrantyClaim',
            'group_by_field'        => 'created_at',
