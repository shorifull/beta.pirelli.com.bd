...
@section('content')
 <section class="scorpion-header" id="scorpion-header" >
        <div class="container">
            <div class="row">
            <div class="col-sm-12">
                 <h1 class="text-center"><span style="color:#fff;font-weight:800;">PIRELLI SCORPION™</span></h1>
...
{{--                                Search Form Start--}}
 ...
 <section style="background: #f1f1f1;padding:50px 0;" class="py-5">
        <div class="container mt-3">
            ...
            <div class="row">
                   <div class="col-md-5">
                    <img class="img-fluid" src="{{asset('/images/car/scorpion.webp')}}" >

                </div>
                <div class="col-md-1"></div>
                <div class="col-md-6">
                       <h3 style="margin:10px 0px;" class="technology-section-title">SCORPION™</h3>
            <h3 style="text-align:left;font-family:'gotham-black'">SCORPION™ VERDE ALL SEASON</h3>     
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle8">
                        ...
                        <div class="progress-value"><span class="label">8</span><br> WET</div>
                    </div>
                </div>
                 ...
                 <div class="col-md-2 col-sm-6">
                    <div class="progress circle7">
                        ...
                        <div class="progress-value"><span class="label">7</span><br> SNOW</div>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle9">
                        ...
                        <div class="progress-value"><span class="label">9</span><br>COMFORT</div>
                    </div>
                </div>
                          <div class="col-md-2 col-sm-6">
                    <div class="progress circle6">
                        ...
                        <div class="progress-value"><span class="label">6</span><br> OFFROAD</div>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle9">
                        ...
                        <div class="progress-value"><span class="label">9</span><br> MILEAGE</div>
                    </div>
                </div>
...
An Original Equipment tyre is a custom-made product developed for a specific car model, to ensure the perfect tyre for every customer.
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                 <h1 class="text-center"><span style="color:#000;font-weight:800;">SCORPION™ VERDE ALL SEASON DETAILS</span></h1>
                  <img class="img-fluid" src="{{asset('/images/car/scorpion_verde_all_season_base.jpeg')}}" >
