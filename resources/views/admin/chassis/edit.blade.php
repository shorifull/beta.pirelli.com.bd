        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.chassis.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.chassis.update", [$chassis->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('chassis') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="chassis" id="chassis" value="{{ old('chassis', $chassis->chassis) }}" required>
