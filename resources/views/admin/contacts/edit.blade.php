                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('contact_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="contact_address" id="contact_address">{{ old('contact_address', $contact->contact_address) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('contact_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', $contact->contact_email) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_phone_number" id="contact_phone_number" value="{{ old('contact_phone_number', $contact->contact_phone_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_fax_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_fax_number" id="contact_fax_number" value="{{ old('contact_fax_number', $contact->contact_fax_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_map_i_frame') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="contact_map_i_frame" id="contact_map_i_frame">{{ old('contact_map_i_frame', $contact->contact_map_i_frame) }}</textarea>
