                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.emails.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('send_email_from') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="send_email_from" id="send_email_from" value="{{ old('send_email_from', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('receive_email_to') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="receive_email_to" id="receive_email_to" value="{{ old('receive_email_to', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('smtp_activated') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="smtp_activated" id="smtp_activated">
                                ...
                                @foreach(App\Models\Email::SMTP_ACTIVATED_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('smtp_activated', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('smtp_ssl') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="smtp_ssl" id="smtp_ssl">
                                ...
                                @foreach(App\Models\Email::SMTP_SSL_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('smtp_ssl', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('smtp_port') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="smtp_port" id="smtp_port" value="{{ old('smtp_port', '') }}">
