                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.headers.update", [$header->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('meta_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $header->meta_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('meta_keyword') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="meta_keyword" id="meta_keyword">{{ old('meta_keyword', $header->meta_keyword) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ old('meta_description', $header->meta_description) }}</textarea>
