                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.footers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('footer_about_us') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="footer_about_us" id="footer_about_us">{{ old('footer_about_us') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('footer_copyright') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="footer_copyright" id="footer_copyright" value="{{ old('footer_copyright', '') }}">
