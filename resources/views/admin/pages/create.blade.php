                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.pages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('page_content') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="page_content" id="page_content">{!! old('page_content') !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('active') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Page::ACTIVE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="active_{{ $key }}" name="active" value="{{ $key }}" {{ old('active', '') === (string) $key ? 'checked' : '' }}>
