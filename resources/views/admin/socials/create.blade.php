                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.socials.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('google_plus') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="google_plus" id="google_plus" value="{{ old('google_plus', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('you_tube') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="you_tube" id="you_tube" value="{{ old('you_tube', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('tumblr') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tumblr" id="tumblr" value="{{ old('tumblr', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('flickr') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="flickr" id="flickr" value="{{ old('flickr', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('reddit') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="reddit" id="reddit" value="{{ old('reddit', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('snapchat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="snapchat" id="snapchat" value="{{ old('snapchat', '#') }}">
                        ...
                        <div class="form-group {{ $errors->has('quora') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="quora" id="quora" value="{{ old('quora', '#') }}">
                            @if($errors->has('quora'))
