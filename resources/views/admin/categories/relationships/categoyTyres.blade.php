            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-categoyTyres">
                            <thead>
                                <tr>
                                    <th width="10">
                            ...
                            <tbody>
                                @foreach($tyres as $key => $tyre)
                                    <tr data-entry-id="{{ $tyre->id }}">
                                        ...
                                        <td>
                                            @foreach($tyre->model_combinations as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-categoyTyres:not(.ajaxTable)').DataTable({ buttons: dtButtons })
