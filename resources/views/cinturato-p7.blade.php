...
@section('content')
 <section class="cinturato-header" id="cinturato-header" >
        <div class="container">
            <div class="row">
            <div class="col-sm-12">
                 <h1 class="text-center"><span style="color:#fff;font-weight:800;">PIRELLI CINTURATO™</span></h1>
...
{{--                                Search Form Start--}}
 ...
 <section style="background: #f1f1f1;padding:50px 0;" class="py-5">
        <div class="container mt-3">
            ...
            <div class="row">
                   <div class="col-md-5">
                    <img class="img-fluid" src="{{asset('/images/car/cinturato-p7.webp')}}" >

                </div>
                <div class="col-md-1"></div>
                <div class="col-md-6">
                       <h3 style="margin:10px 0px;" class="technology-section-title">P7C2</h3>
            <h3 style="text-align:left;font-family:'gotham-black'">CINTURATO P7™ (P7C2)</h3>     
            <p>CINTURATO P7™ (P7C2) is the latest Pirelli Summer high-performance tyre for premium cars and Crossovers with a strong focus on wet performances, mileage and rolling resistance. These features are perfectly balanced, making the new Cinturato the first choice for the best car manufacturers. The new tread pattern design and profile, in addition to the innovative compound materials, guarantees extreme levels of SAFETY, EFFICIENCY, SUSTAINABILITY and TECHNOLOGY. Leading to a reduction in braking distance, fuel consumption, noise emissions and the presence of the latest technological innovations, CINTURATO P7™ (P7C2) is the best choice to always be IN CONTROL of your vehicle.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle9">
                        ...
                        <div class="progress-value"><span class="label">9</span><br> DRY</div>
                    </div>
                </div>
                
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle10">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">10</span><br> WET</div>
                    </div>
                </div>
                
                 <div class="col-md-2 col-sm-6">
                    <div class="progress circle6">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">6</span><br> SPORT</div>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle10">
                        ...
                        <div class="progress-value"><span class="label">10</span><br>COMFORT</div>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle10">
                        ...
                        <div class="progress-value"><span class="label">10</span><br> MILEAGE</div>
                    </div>
                </div>
                  <div class="col-md-1"></div>
...
An Original Equipment tyre is a custom-made product developed for a specific car model, to ensure the perfect tyre for every customer.
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                 <h1 class="text-center"><span style="color:#000;font-weight:800;">CINTURATO P7™ (P7C2) DETAILS</span></h1>
                  <img class="img-fluid" src="{{asset('/images/car/cinturato_P7_base.png')}}" >
