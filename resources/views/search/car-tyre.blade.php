  ...
  <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-center mt-2">
                                                <a class="btn get-quote-btn" href="{{route('contact')}}"><span>Get Quote</span></a>
                                                 ...
                                                 <a class="btn find-dealer-btn" href="{{ route('car-retailer-list')}}"><span>Find Your Dealer</span></a>
                                            </div>
    ...
    <!-- Progress bar --> 
        <section id="progress-bar">
                <div class="container">
                    <h3 style="font-family:'gotham-black', sans-serif;color:#fff;font-weight:bold;" class="mb-5">PERFORMANCE</h3>
            <div class="row">
                <div class="col-md-1"></div>
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle{{$tyre->dry_id ?? '8'}}">
                        ...
                        <div class="progress-value"><span class="label">{{$tyre->dry_id ?? '8'}}</span><br> DRY</div>
                    </div>
                </div>
                
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle{{$tyre->wet_id ?? '1'}}">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">{{$tyre->wet_id ?? '1'}}</span><br> WET</div>
                    </div>
                </div>
                
                 <div class="col-md-2 col-sm-6">
                    <div class="progress circle{{$tyre->sport_id ?? '1'}}">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">{{$tyre->sport_id ?? '1'}}</span><br> SPORT</div>
                    </div>
                </div>
                
                
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle{{$tyre->comfort_id ?? '1'}}">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">{{$tyre->comfort_id ?? '1'}}</span><br>COMFORT</div>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6">
                    <div class="progress circle{{$tyre->mileage_id ?? '1'}}">
                        <span class="progress-left">
                            <span class="progress-bar"></span>
                        </span>
                        <span class="progress-right">
                        ...
                        <div class="progress-value"><span class="label">{{$tyre->mileage_id ?? '1'}}</span><br> MILEAGE</div>
                    </div>
                </div>
                  <div class="col-md-1"></div>
...
<div class="section tyre-bottom-section">    
    <div class="container">
        ...
        <ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
                         <li class="nav-item">
    <a class="nav-link" id="pills-applications-tab" data-toggle="pill" href="#pills-applications" role="tab" aria-controls="pills-applications" aria-selected="true">Car Applications</a>
  </li>
                 <li class="nav-item">
    ...
    <div class="row">
        <div class="col-md-12">
              ...
              <div class="tab-pane fade" id="pills-applications" role="tabpanel" aria-labelledby="pills-applications-tab">
                     ...
                     <ul>
                            @if(count($tyre->model_combinations) > 0)
                                                    @foreach($tyre->model_combinations as $model_combination)
                                                        <li>{{ $model_combination->brand->brand ?? '' }} ({{ $model_combination->car_model->model ?? '' }}-@foreach($model_combination->years as $key => $item)<span class="label label-info label-many">{{ $item->year }}</span>@endforeach)
