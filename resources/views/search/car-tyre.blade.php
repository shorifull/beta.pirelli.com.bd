    ...
    <section class="py-5 bg-light tyre-details">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-lg-6">
                    <div class="">
                        <span class="badge badge-info rounded-pill px-3 py-1 font-weight-light">Pirelli Car Tyre</span>
                                    ...
                                    <div class="card-body">
                                        <div class="row p-3">
                                            <div class="col-6 border-right">
                                                ...
                                                @if(count($tyre->model_combinations) > 0)
                                                    @foreach($tyre->model_combinations as $model_combination)
                                                        <h6 class="text-muted font-weight-light">{{ $model_combination->brand->brand ?? '' }}</h6>
                                                    @endforeach
                                                @endif
                                            </div>
                                            <div class="col-6 text-right border-left">
                                                ...
                                                @if(count($tyre->model_combinations) > 0)
                                                    @foreach($tyre->model_combinations as $model_combination)
                                                        <h6 class="text-muted font-weight-light">{{ $model_combination->car_model->model ?? '' }}</h6>
                                                    @endforeach
                                                @endif
