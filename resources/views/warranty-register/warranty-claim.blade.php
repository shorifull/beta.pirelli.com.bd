    ...
    <div class="container container-costum-margin">
        <div class="row">
            ...
            <div class="col-xl-7 col-lg-7 col-12">
                <form method="post" action="{{ route('claim-car-warranty') }}" id="warrantyClaim" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="final-step-btn">
                        ...
                        <button class="g-recaptcha costum-btn btn-confirm btn btn-primary btn-lg " data-sitekey="{{ config('services.recaptcha.key') }}" data-callback="onSubmit" data-action="submitContact">REGISTER NOW</button>
                    </div>
            ...
            <div class="col-xl-5 col-lg-5 col-12">
                ...
                <div class="terms-policy">
                    ...
                    <div class="find-out-more-btn">
                        ...
                        <a style="text-align:center;" target="_blank" href="{{asset('Pirelli Tyre Warranty Policy PDF - Download 1111.pdf')}}">
